...
export default function Modal({ children, display, onClose}) {
    ...
    return (
        <div className={`w-full absolute z-50 ${display ? 'block' : 'hidden'} overflow-hidden`}>
            ...
            <div className={`bg-white p-8 z-50 relative max-w-md h-screen overflow-hidden transition-transform duration-300 ease-in-out ${display ? 'translate-x-0' : 'translate-x-full'}`}>
