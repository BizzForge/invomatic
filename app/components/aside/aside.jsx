...
export default function Aside() {
    ...
    return (
    <aside className={`aside w-full ${isOpen ? 'md:w-80 transition-all ease-in-out' : 'md:w-16 transition-all ease-in-out' } overflow-hidden bg-white z-40 flex md:block md:bg-white px-2 py-5 h-20 md:h-[calc(100vh)] transform md:shadow-lg fixed`}>
